...
public class ClientLabyrinth extends Fenster {
     ...
     */
    private int aktPlayer = 0;

    /**
     * Array aller Player
     * @see mainPackage.Player
     */
    private GraphicsPlayer[] mPlayer;
    ...
    /**
     * Wahrheitswert, ob aktuell ein Dialogfenster ge�ffnet ist.
     */
     ...
     * Die Methode pr�ft au�erdem, ob der aktuelle Player auf einem Item steht
    ...
    public void draw(Graphics g) {
        if (mPlayer != null && mLabyrinth != null && mImageLab != null) {
            ...
            if (isDialogActive && getItemAtPlace() != null) {
                mDialogDrawer.drawItemDialog(g, Items.toString(getItemAtPlace()), "Ein Schl�ssel am Platz!");
            }

            //			if (getAktPlayer().itemAtPlace(items.KEY)) {
            ////				String text = "�ffne im A-Geb�ude den Safe und sichere die geheimen Unterlagen!";
            ////				mDialogDrawer.drawItemDialog(g, "Schl�ssel", text);
            ////				removeItem();
            //				
            //			} else if (getAktPlayer().itemAtPlace(items.BUCKET)) {
            //				String text = "Begib dich ins N-Geb�ude und putze alle Toiletten!";
            ////				mDialogDrawer.drawItemDialog(g, "Putzeimer", text);
            //				removeItem();
            //				
            //			} else if (getAktPlayer().itemAtPlace(items.BRUSH)) {
            //				String text = "Suche dir einen zweiten Mitspieler und bemalt zusammen im Kunstraum die wei�en W�nde!";
     ...
     * auf 0 zur�ckgesetzt und das Labyrinth wird neu gezeichnet.
     */
    ...
    /**
     * Gibt die Gr��eneinheit des ClientLabyrinths zur�ck
     * 
     ...
     * 
     * @param pImageLab BufferedImage, welches das aktuelle Bild des Irrgartens enth�lt
     */
     ...
     */
    public void setPlayers(GraphicsPlayer[] pPlayer) {
        mPlayer = pPlayer;
    }

    /**
     * Gibt den Irrgarten zur�ck
     * 
    ...
    /**
     * Gibt den aktuellen Player zur�ck, mit dem der Client spielt.
     * 
     * @return aktueller Player, wenn vorhanden. 
     * @return null, wenn {@link #aktPlayer} kleiner als 0 ist.
     */
    public GraphicsPlayer getAktPlayer() {
        if (aktPlayer >= 0)
    ...
    /**
     * F�hrt Aktionen aus, wenn ein Player auf einem Item steht und, wenn bestimmte Tasten gedr�ckt wurden.
     * <p>
     * Die Methode wird in {@link #keyPressed(KeyEvent)} aufgerufen und erh�lt von dort auch das {@link KeyEvent}.
     * <p>
     ...
     *    <td>Dialog schlie�en</td>
     * </tr>
     * </table>
     * </blockquote>
     * 
     * @param e KeyEvent, welches die Tastenanschl�ge �bergibt. 
    ...
    /**
     * Pr�ft, welche Taste gedr�ckt wurde und sendet eine entsprechende Meldung an
     * den EchoServer. 
     * <p>
     * Bezieht sich haupts�chlich auf die Bewegung des aktuellen Players.
     * 
     * @param e KeyEvent, welches die Tastenanschl�ge �bergibt. 
     * 
