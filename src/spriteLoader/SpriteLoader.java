...
//		mFileReader = FileReader.getInstance();
	 ...
	 * 
	 * @deprecated Die Methode wird aufgrund einer Codeaufbereitung nicht mehr ben�tigt. 
	 * 			   Vorher wurde mit Images anstatt mit BufferedImages gearbeitet.
	 * 			   Es ist also keine Umstellung n�tig, da alle Methoden nun mit BufferedImages arbeiten.
