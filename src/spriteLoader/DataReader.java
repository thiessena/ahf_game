...
/**
 * Greift auf die Ordnerstruktur zu und importiert alle n�tigen Elemente.
 * Sowohl Bilder bzw. Grafiken als auch Schriftarten werden geladen und in separaten HashMaps abgelegt.
 * Sofern ein Bild keinen Avatar enth�lt, werden diese schon skaliert, um die Performance zu steigern.
 * 
...
public class DataReader {
	...
	/**
	 * Scalewert / Gr��eneinheit des ClientLabyrinths (<code>1 px = 1 scl</code>).
	 * <p>
	 * Auf diese maximale Gr��e werden alle Items au�er dem Avatar herunterskaliert ({@link #readFiles()}), 
     ...
     * Ein Aufruf des Konstruktors ist nur �ber die Methoden {@link #getInstance(String, String)}
     * und {@link #getInstance(String, String, String, String[], String[])} m�glich, um sicherzustellen,
	 ...
	 * @param pImageExtensions	Array mit den Bilddateiendungen, die zu ber�cksichtigen sind.
	 * @param pFontExtensions	Array mit den Schriftdateiendungen, die zu ber�cksichtigen sind.
	 * 
	 * @see #readFiles()
     */
    ...
    /**
	 * Gibt eine Instanz des {@link spriteLoader.DataReader} zur�ck.
	 * <p>
	 * Somit wird sicher gestellt, dass im AHF Simulator nur eine Instanz dieser Klasse existiert.
	 * <p>
	 * Die �brigen Parameter werden in dieser Methode standardm��ig in dieser Klasse gesetzt.
	 * Falls dies nicht gew�nscht ist, so kann {@link #getInstance(String, String, String, String[], String[])}
	 * aufgerufen werden.
	 * <p>
	 * F�r die Bild-Dateiendungen wird hier standardm��ig der Array {@link #IMG_EXTENSIONS} �bernommen.
     * Gleiches gilt f�r die Schrift-Dateiendungen. Diese werden hier standardm��ig von 
     * {@link #FONT_EXTENSIONS} �bergeben.
	 * 
     * @param pImageFolder Ordner als String, aus dem die Bilder und Items importiert werden sollen.
     * @param pAvatarName  Name als String des Avatars, der als Spielfigur dient.
	...
	/**
	 * Gibt eine Instanz des {@link spriteLoader.DataReader} zur�ck. Wenn bereits eine Instanz dieser Klasse 
	 * vorhanden ist, so wird die existierende Instanz zur�ckgegeben. Andernfalls wird eine neue
	 * Instanz initialisiert.
	 * Somit wird sicher gestellt, dass im AHF Simulator nur eine Instanz dieser Klasse existiert.
	 * <p>
     * Sofern die Bild-Dateiendungen, die dem FileReader �bergeben wurden, mit denen der {@link #IMG_EXTENSIONS} 
     * �bereinstimmen, werden diese ignoriert und stattdessen der Array �bernommen, der standardm��ig gesetzt ist.
     * Gleiches gilt f�r die Schrift-Dateiendungen und den Array {@link #FONT_EXTENSIONS}.
	 * 
	 * @param pImageFolder		Ordner als String, aus dem die Bilder und Items importiert werden sollen.
	 * @param pFontFolder		Ordner als String, aus dem die Schriften importiert werden sollen.
	 * @param pAvatarName		Name als String des Avatars, der als Spielfigur dient.
	...
	/**
	 * Gibt die HashMap mit den importierten Schriften zur�ck.
	 * 
	...
	/**
	 * Gibt die HashMap mit den importierten Items und Bildern zur�ck.
	 * 
	...
	/**
	 * Skaliert ein Bild auf eine neue Gr��e und gibt das skalierte Bild zur�ck.
	 * 
	...
	/**
	 * Erstellt einen neuen Dateifilter mit zu �bergebenden Dateiendungen.
	 * 
