...
public abstract class Client {
	...
	/**
	 * Hilfsklasse f�r den Client, die in einem eigenen Thread den Empfang einer
	...
	class Clientempfaenger extends Thread {
		...
		/**
		 * Der ClientEmpfaenger hat den zugeh�rigen Client und die zugeh�rige
		 * Connection kennen gelernt.<br>
		 * 
		 * @param pClient     zugeh�riger Client, der die einkommenden Nachrichten
		 *                    bearbeitet
		 * @param pConnection zugeh�rige Connection, die die einkommenden
	 ...
	 * Diese abstrakte Methode muss in Unterklassen �berschrieben werden.
	 * 
