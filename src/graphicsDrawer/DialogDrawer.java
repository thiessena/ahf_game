...
/**
 * Zeichnet Dialoge in ein vom ClientLabyrinth �bergegebenes Graphics Panel.
 * 
...
public class DialogDrawer {
	...
	/**
	 * Setzt die Member-Variablen, die vom ClientLabyrinth �bergeben wurden.
	 * 
	...
	/**
	 * Zeichnet einen Kommunikationsdialog mit zwei Sprechblasen und zwei zu �bergebenden Textnachrichten.
	 * 
	...
	/**
	 * Zeichnet eine Dialog passend zu einem zu �begenden Item und einem zu �bergenden Quest.
	 * 
	 * @param g		   Graphics, auf dem der Dialog gezeichnet werden soll.
	...
	/**
	 * Zeichnet eine sch�ne Sprechblase mit geschwungenem Pfeil. 
	 * Die Methode gibt einen Pfad in Form der Sprechblase zur�ck.
	 * 
	 * @deprecated Die Methode malt zwar eine durchaus sch�nere Sprechblase als 
	 * {@link #drawBubble(Graphics, int, Color, double, double, double, double)}, jedoch 
	 * sind ihre Parameter nur schwer zu ver�ndern. 
	 * <p> 
	 * Der bevorzugte Weg, eine Sprechblase zu zeichnen, ist durch Aufruf der obigen Methode.
	 * 
	 * @param pScale  Gr��eneinheit bzw. Skalierungsfaktor, mit der die Sprechblase vergr��ert werden soll.
	 ...
	 * @param pHeight H�he der Sprechblase.
	 * @return Pfad mit der Sprechblase. Der Pfad ist mit keiner Farbe gef�llt!
	 */
...
//		path.curveTo(15 * a + x, h      + y,  5 * a + x, h     + y,  5 * a + x, h - 10 + y);
	...
	/**
	 * Setzt Rendering Hints f�r ein bestimmtes Graphics Panel.
	 * <p>
	 * Rendering Hints beschreiben die Art und Weise, wie das Graphics Panel gezeichnet bzw.&nbsp;gerendert werden soll.
	 * <p>
	 * <b>Hinweis:</b> Diese Methode sollte nicht f�r das Graphics Panel verwendet werden, auf dem der Irrgarten gezeichnet wird, 
	 * sondern wird nur f�r aufwendigere Zeichnungen, wie den Sprechblasen verwendet!
	 * 
	...
	/**
	 * �bermalt ein bestimmtes Graphics Panel mit einem leeren Rechteck in der Hintergrundfarbe vom Fenster.
	 * 
	 * @param g Graphics, das zu �bermalen ist.
	 */
