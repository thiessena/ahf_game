...
public abstract class CorporateDesign {
    ...
    public static final int moodWidth = 96;
    public static final int moodHeight = 143;
    public static final int moodBuff = 0;
    ...
    public static int getMoodWidth() {
        return moodWidth;
    }
    
    public static int getMoodHeight() {
        return moodHeight;
    }
    
    public static int getMoodBuff() {
        return moodBuff;
    }
}
