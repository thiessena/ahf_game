...
public class Mood {
    ...
    /**
     * F�llt den {@link moodArray} mit den Moods, die ein Avatar annehmen kann
     * @see elementFactory.avatarMoods
     */
    private Mood() {
    ...
    /**
     * Gibt die Instanz dieser Klasse zur�ck.
     * 
    ...
    /**
     * Gibt den Mood an einer bestimmten Stelle im Array zur�ck
     * 
     * @param x <code>x</code>-Koordinate des zur�ckzugebenen Moods
     * @param y <code>y</code>-Koordinate des zur�ckzugebenen Moods
